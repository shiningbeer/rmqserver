...
for line in f:
    line_number+=1
    doc={'ip':line.strip(),'port':port,'ipv4':ipv4}
    x=dao.insert_one(name,doc)
new_task={'name':name,'port':port,'complete':False,'pause':False,'allSent':False,'count':line_number,'progress':0,'ipv4':ipv4,'error':False}
